![docker image](https://github.com/kaust-library/nomad-oasis/actions/workflows/docker-publish.yml/badge.svg)

# kaust-library's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of kaust-library. 
...
```sh
curl -L -o nomad-oasis.zip "https://github.com/kaust-library/nomad-oasis/raw/main/nomad-oasis.zip"
```
...
your `docker-compose.yaml` with `ghcr.io/kaust-library/nomad-oasis:main` for the services
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/kaust-library/nomad-oasis/manifests/main": unauthorized`
